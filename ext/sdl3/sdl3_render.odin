...
TextureAccess :: enum c.int {
	...
	TARGET, /**< Render_Texture can be used as a render target */
}
...
foreign lib {
	...
	CreateTexture :: proc(renderer: ^Renderer, format: PixelFormat, access: TextureAccess, w, h: c.int) -> ^Render_Texture ---
	CreateTextureFromSurface :: proc(renderer: ^Renderer, surface: ^Surface) -> ^Render_Texture ---
	CreateTextureWithProperties :: proc(renderer: ^Renderer, props: PropertiesID) -> ^Render_Texture ---
	GetTextureProperties :: proc(texture: ^Render_Texture) -> PropertiesID ---
	GetRendererFromTexture :: proc(texture: ^Render_Texture) -> ^Renderer ---
	GetRenderTarget :: proc(renderer: ^Renderer) -> Maybe(^Render_Texture) ---
...
foreign lib {
	...
	GetTextureSize :: proc(texture: ^Render_Texture, w, h: ^f32) -> bool ---
	SetTextureColorMod :: proc(texture: ^Render_Texture, r, g, b: Uint8) -> bool ---
	SetTextureColorModFloat :: proc(texture: ^Render_Texture, r, g, b: f32) -> bool ---
	GetTextureColorMod :: proc(texture: ^Render_Texture, r, g, b: ^Uint8) -> bool ---
	GetTextureColorModFloat :: proc(texture: ^Render_Texture, r, g, b: ^f32) -> bool ---
	SetTextureAlphaMod :: proc(texture: ^Render_Texture, alpha: Uint8) -> bool ---
	SetTextureAlphaModFloat :: proc(texture: ^Render_Texture, alpha: f32) -> bool ---
	GetTextureAlphaMod :: proc(texture: ^Render_Texture, alpha: ^Uint8) -> bool ---
	GetTextureAlphaModFloat :: proc(texture: ^Render_Texture, alpha: ^f32) -> bool ---
	SetTextureBlendMode :: proc(texture: ^Render_Texture, blendMode: BlendMode) -> bool ---
	GetTextureBlendMode :: proc(texture: ^Render_Texture, blendMode: ^BlendMode) -> bool ---
	SetTextureScaleMode :: proc(texture: ^Render_Texture, scaleMode: ScaleMode) -> bool ---
	GetTextureScaleMode :: proc(texture: ^Render_Texture, scaleMode: ^ScaleMode) -> bool ---
	UpdateTexture :: proc(texture: ^Render_Texture, rect: Maybe(^Rect), pixels: rawptr, pitch: c.int) -> bool ---
	UpdateYUVTexture :: proc(texture: ^Render_Texture, rect: Maybe(^Rect), Yplane: [^]Uint8, Ypitch: c.int, Uplane: [^]Uint8, Upitch: c.int, Vplane: [^]Uint8, Vpitch: c.int) -> bool ---
	UpdateNVTexture :: proc(texture: ^Render_Texture, rect: Maybe(^Rect), Yplane: [^]Uint8, Ypitch: c.int, UVplane: [^]Uint8, UVpitch: c.int) -> bool ---
	LockTexture :: proc(texture: ^Render_Texture, rect: Maybe(^Rect), pixels: ^rawptr, pitch: ^c.int) -> bool ---
	LockTextureToSurface :: proc(texture: ^Render_Texture, rect: Maybe(^Rect), surface: ^^Surface) -> bool ---
	UnlockTexture :: proc(texture: ^Render_Texture) ---
	SetRenderTarget :: proc(renderer: ^Renderer, texture: Maybe(^Render_Texture)) -> bool ---
	...
	RenderTexture :: proc(renderer: ^Renderer, texture: ^Render_Texture, srcrect, dstrect: Maybe(^FRect)) -> bool ---
	RenderTextureRotated :: proc(renderer: ^Renderer, texture: ^Render_Texture, srcrect, dstrect: Maybe(^FRect), angle: f64, #by_ptr center: FPoint, flip: FlipMode) -> bool ---
	RenderTextureAffine :: proc(renderer: ^Renderer, texture: ^Render_Texture, srcrect: Maybe(^FRect), origin, right, down: Maybe(^FPoint)) -> bool ---
	RenderTextureTiled :: proc(renderer: ^Renderer, texture: ^Render_Texture, srcrect: Maybe(^FRect), scale: f32, dstrect: Maybe(^FRect)) -> bool ---
	RenderTexture9Grid :: proc(renderer: ^Renderer, texture: ^Render_Texture, srcrect: Maybe(^FRect), left_width, right_width, top_height, bottom_height: f32, scale: f32, dstrect: Maybe(^FRect)) -> bool ---
	RenderGeometry :: proc(renderer: ^Renderer, texture: ^Render_Texture, vertices: [^]Vertex, num_vertices: c.int, indices: [^]c.int, num_indices: c.int) -> bool ---
	RenderGeometryRaw :: proc(renderer: ^Renderer, texture: ^Render_Texture, xy: [^]f32, xy_stride: c.int, color: [^]FColor, color_stride: c.int, uv: [^]f32, uv_stride: c.int, num_vertices: c.int, indices: rawptr, num_indices: c.int, size_indices: c.int) -> bool ---
	RenderPresent :: proc(renderer: ^Renderer) -> bool ---
	DestroyTexture :: proc(texture: ^Render_Texture) ---
