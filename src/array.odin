...
@(require_results)
array_in_bounds :: #force_inline proc "contextless" (
	a: $A/Array($N, $T),
	#any_int index: int,
) -> bool {
...
array_inject_at :: proc "contextless" (
	a: ^$A/Array($N, $T),
	item: T,
	#any_int index: int,
...
@(require_results)
soa_array_in_bounds :: #force_inline proc "contextless" (
	a: $A/Soa_Array($N, $T),
	#any_int index: int,
) -> bool {
	return index >= 0 && index < a.len
...
@(require_results)
soa_array_get :: #force_inline proc "contextless" (
	a: $A/Soa_Array($N, $T),
	#any_int index: int,
) -> T {
	return a.data[index]
...
@(require_results)
soa_array_get_ptr :: #force_inline proc "contextless" (
	a: ^$A/Soa_Array($N, $T),
	#any_int index: int,
) -> #soa^#soa[N]T {
	return &a.data[index]
...
@(require_results)
soa_array_get_safe :: proc "contextless" (
	a: $A/Soa_Array($N, $T),
	#any_int index: int,
) -> (
	T,
...
soa_array_inject_at :: proc "contextless" (
	a: ^$A/Soa_Array($N, $T),
	item: T,
	#any_int index: int,
) -> bool #no_bounds_check {
